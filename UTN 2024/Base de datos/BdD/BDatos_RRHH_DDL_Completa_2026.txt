CREATE DATABASE  IF NOT EXISTS `recursos_humanos` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `curriculum` (
  ...
  PRIMARY KEY (`tipo_doc`,`nro_doc`,`cod_competencia`,`fecha_curric`),
...
CREATE TABLE `proceso_seleccion` (
  ...
  PRIMARY KEY (`cod_area`,`cod_puesto`,`fecha_solic`,`tipo_doc`,`nro_doc`,`fecha_hora`),
  KEY `proceso_seleccion_empleados_fk_idx` (`legajo`),
  KEY `proceso_seleccion_personas_fk_idx` (`tipo_doc`,`nro_doc`),
  KEY `proceso_seleccion_estados_idx` (`cod_estado`),
  CONSTRAINT `proceso_seleccion_empleados_fk` FOREIGN KEY (`legajo`) REFERENCES `empleados` (`legajo`),
  CONSTRAINT `proceso_seleccion_estados` FOREIGN KEY (`cod_estado`) REFERENCES `estados` (`cod_estado`),
  CONSTRAINT `proceso_seleccion_personas_fk` FOREIGN KEY (`tipo_doc`, `nro_doc`) REFERENCES `personas` (`tipo_doc`, `nro_doc`),
  CONSTRAINT `proceso_seleccion_solicitudes_puestos_fk` FOREIGN KEY (`cod_area`, `cod_puesto`, `fecha_solic`) REFERENCES `solicitudes_puestos` (`cod_area`, `cod_puesto`, `fecha_solic`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salario` VALUES (1,1,'2016-11-08',177.78),(1,1,'2016-11-19',357.49),(1,1,'2018-07-17',479.39),(1,3,'2016-08-05',475.10),(1,3,'2018-10-11',490.52),(1,3,'2018-11-10',375.70),(1,4,'2016-12-12',450.59),(1,4,'2017-02-27',860.56),(1,4,'2018-04-05',1500.25),(1,8,'2016-02-08',156.99),(1,8,'2016-02-14',132.66),(1,8,'2016-04-02',321.45),(2,5,'2017-07-13',213.77),(2,5,'2017-10-10',129.91),(2,5,'2018-12-28',261.08),(2,6,'2016-01-09',355.95),(2,6,'2018-09-05',177.55),(2,6,'2018-11-19',123.03),(2,8,'2017-01-13',492.80),(2,8,'2017-04-21',52.62),(2,8,'2018-05-03',178.52),(3,8,'2016-12-13',285.78),(3,8,'2017-08-07',186.94),(3,8,'2018-10-16',299.99),(3,9,'2016-12-22',258.43),(3,9,'2018-02-10',231.68),(3,9,'2018-05-12',494.41),(4,8,'2016-02-25',356.58),(4,8,'2016-11-20',305.18),(4,8,'2017-01-02',363.71),(4,10,'2018-04-09',140.17),(4,10,'2018-05-27',234.73),(4,10,'2018-06-25',105.90),(4,11,'2016-09-20',380.83),(4,11,'2017-06-11',139.59),(4,11,'2017-11-24',44.41),(5,5,'2017-03-01',142.78),(5,5,'2017-03-13',312.03),(5,5,'2018-01-23',343.24),(5,8,'2016-02-04',9.88),(5,8,'2016-08-09',268.30),(5,12,'2017-04-17',437.23),(5,12,'2017-04-18',122.90),(5,12,'2018-05-14',224.51),(5,13,'2017-07-24',473.62),(5,13,'2017-08-06',209.34),(5,13,'2018-12-24',88.05),(5,14,'2016-06-14',486.38),(5,14,'2017-02-10',223.48),(5,14,'2017-05-21',400.76);
...
CREATE TABLE `solicitudes_puestos` (
  ...
  `cod_puesto` int NOT NULL,
  `fecha_solic` date NOT NULL,
  `cant_puestos_solic` int DEFAULT NULL,
  `cant_puestos_cubiertos` int DEFAULT NULL,
  `cant_hs_trabajo` int DEFAULT NULL,
...
-- Dump completed on 2023-05-23  9:13:04
