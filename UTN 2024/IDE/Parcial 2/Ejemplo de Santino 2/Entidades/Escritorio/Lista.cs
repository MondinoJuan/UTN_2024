...
namespace Escritorio
{
    public partial class Lista : Form
    {
        ...
        {
            ClienteApiAlumno client = new ClienteApiAlumno();
            //var alumnos =   await ClienteApiAlumno.GetAll(); // Obtener lista de alumnos de la api
            var servi = new AlumnoServiceADO();
            var alumnos = servi.GetAll();
            //var alumnos = AlumnoNegocio.RecuperarTodos(); // Obtener lista de alumnos del service
            comboBoxAlumnos.DataSource = alumnos; // Establecer la lista en el ComboBox
        ...
        private async void CargarAlumnosGrid()
        {
            ClienteApiAlumno client = new ClienteApiAlumno();
            var alumnos = await ClienteApiAlumno.GetAll(); // Obtener lista de alumnos de la api
            dataGridAlumno.DataSource = alumnos; // Establecer la lista en el DataGridVie
            dataGridAlumno.DisplayedColumnCount(true);
